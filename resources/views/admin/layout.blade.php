...
<html lang="en">
  ...
  <body class="nav-md">
            ...
            <nav class="nav navbar-nav">
              <ul class=" navbar-right">
                  ...
                  <a href="javascript:;" class="dropdown-toggle info-number" id="navbarDropdown1" data-toggle="dropdown" aria-expanded="false">
                      ...
                      <span class="badge bg-green">{{$noUnreadMsges}}</span>
                  </a>
                  <ul class="dropdown-menu list-unstyled msg_list" role="menu" aria-labelledby="navbarDropdown1">
                      @foreach($unreadMsges as $unreadMsg)
                      <li class="nav-item">
                        <a class="dropdown-item">
                            <span class="image"><img src="{{asset('images/img.jpg')}}" alt="Profile Image" /></span>
                            <span>
                            
                            <span>{{$unreadMsg->first_name}} {{$unreadMsg->last_name}}</span>
                            <span class="time">{{ $unreadMsg->created_at->diffForHumans() }}</span>
                            </span>
                            <span class="message">
                              {{$unreadMsg->content}}
                            </span>
   ...
   <script src="{{asset('vendors/bootstrap/dist/js/bootstrap.bundle.min.js')}}"></script>
    ...
    <script src="{{asset('vendors/datatables.net-buttons/js/buttons.blade.php5.min.js')}}"></script>
