...
@section('content')
          ...
          <section class="login_content">
            <form method="POST" action="{{ route('register') }}">
              ...
              <div>
                <input id="user_name" type="text" placeholder="Username" class="form-control @error('name') is-invalid @enderror" name="user_name" value="{{ old('user_name') }}" required autocomplete="user_name" autofocus>
              ...
              <div>
                <button type="submit" class="btn"  >
                    <span style="font-weight: normal; font-size: 12px;">Submit</span>                 
                </button>
              </div>
